...
const testimonials: TestimonialsType[] = [
  {
    ...
    role: 'CEO at InnovateX Solutions',
    image: 'https://randomuser.me/api/portraits/men/45.jpg',
    text: 'Working with John was an absolute pleasure. His attention to detail, creative insights, and ability to translate complex ideas into stunning visuals truly set him apart. He consistently went above and beyond to ensure the project exceeded expectations.',
    link: '#',
  },
  {
    name: 'Ikechukwu Okafor',
    role: 'Founder at TechNova Solutions',
    image: 'https://randomuser.me/api/portraits/men/50.jpg',
    text: 'John brought my brand vision to life better than I could have imagined. He is not only professional and highly skilled but also incredibly responsive and collaborative. Every aspect of the project was handled with precision and creativity.',
    link: '#',
  },
